...
Related Links: https://xchain.io/asset/PEPEBALT
...
Significance: While [this asset](https://xchain.io/asset/VICEPEPE) was a card in the [Rare Pepe Directory](http://rarepepedirectory.com/), it also held a historical start and perspective of using a Counterparty Token to represent saving an internet link or article. This asset, minted by Scrilla, had an image that was pointing to a very real [VICE magazine article](https://www.vice.com/en/article/aejvdb/collectors-are-using-the-blockchain-to-keep-rare-pepes-rare) with the intention to save a piece of the article. The fear was that this article might be removed from the internet at a future date and to cryptographically stamp it's existense. This theory would eventually influence a project using Ethereum called [Marble Cards](https://marble.cards/whitepaper) which attached specific websites of the user's choosing to a cryptographic token.
